...
textToDisplay = '<iframe width="960px" scrolling="no" height="150px" frameborder="0"';
textToDisplay += 'style="border: 0px none;" src="https://www.marseille.fr/sitevdm/footer.html">';
...
function jPopup(largeur,hauteur){
	...
	var str = getCookie(_siteRefCookie);
	if (str !==undefined) {
		if (str.trim() != _siteValueCookie.trim()) {
